          ...
          <div className="flex items-center gap-3">
            {socials.map((s) => (
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                aria-label={s.label}
                className="w-10 h-10 rounded-xl glass border border-white/8 flex items-center justify-center text-white/40 hover:text-white hover:border-white/20 transition-all duration-200"
              >
                {s.icon}
              </motion.a>
            ))}
